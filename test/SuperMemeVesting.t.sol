...
//         vestingContract.depositRewards{value: depositAmount}(0);
...
//         uint256 reward1 = address(user1).balance;
//         console.log(reward1);
//         uint256 reward2 = address(user2).balance;
//         console.log(reward2);

//         assertEq(reward1, depositAmount / 3);
//         assertEq(reward2, (depositAmount * 2) / 3);

//         uint256 depositAmount2 = 10 ether;
//         vestingContract.depositRewards{value: depositAmount2}(0);
...
//         assertEq(reward1_2, (depositAmount / 3) + (depositAmount2 / 3));
//         assertEq(reward2_2, ((depositAmount * 2) / 3) + ((depositAmount2 * 2) / 3));
...
//         vestingContract.depositRewards{value: depositAmount3}(0);
//         // Simulate reward accumulation
//         vm.prank(user1);
//         vestingContract.claimReward(0);

//         uint256 reward1_3 = address(user1).balance;
//         console.log(reward1_3);

//         assertEq(reward1_3, (depositAmount / 3) + (depositAmount2 / 3) );

//         vm.prank(user2);
//         vestingContract.claimReward(0);

//         uint256 reward2_3 = address(user2).balance;
//         console.log(reward2_3);
//         assertEq(reward2_3, ((depositAmount * 2) / 3) + ((depositAmount2 * 2) / 3) + depositAmount3);
